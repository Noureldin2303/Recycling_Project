...
<html>
  ...
  if(isset($_POST['submit']))
  {
      ...
      $result1 = mysqli_query($conn,"update downinfo set day='$days' where sname='$sname'");
      $result2 = mysqli_query($conn,"update downinfo set time='$time' where sname='$sname'");
      $result3 = mysqli_query($conn,"update downinfo set voucher='$vou' where sname='$sname'");
      $result4 = mysqli_query($conn,"update downinfo set waste='$waste' where sname='$sname'");
